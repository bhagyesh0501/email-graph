...
{strip}
    <div class="col-lg-6 detailViewButtoncontainer">
        <div class="pull-right btn-toolbar">
            ...
            <button type="button" class="btn btn-default" id="getdata" id=$RECORD>PDF Download</button>
            {/if}
              {if $MODULE eq 'Campaigns' }
            <button type="button" class="btn btn-default" id="getrelcampaignemail" id=$RECORD>Email Graph</button>
            {/if}
